...
function display_testimonials(){
   ...
   <div class="testimonial clearfix">
                            <div class="desc">
                                ...
                                <p class="lead">{$testimonials->description}</p>
                            </div>
                            <div class="testi-meta">
                                <img src="uploads/{$testimonials->file_location}" alt="" class="{$testimonials->full_name}">
                                <h4>{$testimonials->full_name} <small>- {$testimonials->role}</small></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
